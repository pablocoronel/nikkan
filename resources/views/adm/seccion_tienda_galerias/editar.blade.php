	...
	<div class="row">
	    <div class="col-xs-12 col-md-8 col-md-offset-2">
	        <div class="panel panel-default">
				...
				{{-- Formulario --}}
				{{ Form::open(['action' => ['SeccionTiendaGaleriaController@'.$accion, $objeto->fk_producto, $objeto->id], 'method' => $verbo, 'class' => 'form-horizontal', 'files' => true]) }}
					{{csrf_field()}}
				    <fieldset>
				    	<input name="_method" type="hidden" value="PATCH">

				        <div class="form-group">
				        	{!! Form::label('imagen', 'Imagen (500x500px)', ['class' => 'col-sm-3 control-label']) !!}
				            <div class="col-sm-7">
