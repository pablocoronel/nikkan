	...
	<div class="row">
	    <div class="col-xs-12 col-md-8 col-md-offset-2">
	        <div class="panel panel-default">
				...
				{{-- Formulario --}}
				{{ Form::open(['action' => ['SeccionTiendaCategoriaController@'.$accion, $objeto->id], 'method' => $verbo, 'class' => 'form-horizontal', 'files' => true]) }}
					{{csrf_field()}}
				    <fieldset>
				        ...
				        <div class="form-group">
				        	{!! Form::label('fk_familia', 'Nivel', ['class' => 'col-sm-3 control-label']) !!}
							<div class="col-sm-7">
								{!! Form::select('fk_familia', $arrayListado, $objeto->fk_familia) !!}
				        	</div>
				        </div>
